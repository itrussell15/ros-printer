...
class G1 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('tool_speed')) {
        this.tool_speed = initObj.tool_speed
      }
      else {
        this.tool_speed = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [tool_speed]
    bufferOffset = _serializer.int64(obj.tool_speed, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new G1(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [position]
    data.position = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
    // Deserialize message field [tool_speed]
    data.tool_speed = _deserializer.int64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.tool_speed !== undefined) {
      resolved.tool_speed = msg.tool_speed;
    }
    else {
      resolved.tool_speed = 0
    }
