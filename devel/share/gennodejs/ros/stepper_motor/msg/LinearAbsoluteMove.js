...
class LinearAbsoluteMove {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LinearAbsoluteMove(null);
  ...
  static datatype() {
    ...
    return 'stepper_motor/LinearAbsoluteMove';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '20ede19b55b0e17ca9aa650f063809af';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LinearAbsoluteMove(null);
...
module.exports = LinearAbsoluteMove;
